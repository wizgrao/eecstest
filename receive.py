...
packets = receive(packet_size=8+16+8, baud=values.baud, signal_cf=values.sig_cf, clock_cf=values.clock_cf, fdev=values.delta, fs=values.fs, duration=10, taps=50, width = 100)
